...
const baseCommandItems: CommandItem[] = [
  ...
  },
  {
    ...
    description: "Prepare structured board agendas with decisions and supporting notes.",
    href: "/templates/board-meeting-agenda",
    type: "template",
    keywords: ["meeting", "agenda", "board", "template"],
  },
  {
    id: "director-onboarding-checklist",
    title: "Director Onboarding Checklist",
    description: "Track new director setup and orientation tasks.",
    href: "/templates/director-onboarding-checklist",
    type: "template",
    keywords: ["director", "onboarding", "checklist", "people"],
  },
  {
    id: "conflict-of-interest-policy",
    title: "Conflict of Interest Policy",
    description: "Create a clear governance policy for conflicts and disclosures.",
    href: "/templates/conflict-of-interest-policy",
    type: "template",
    keywords: ["policy", "conflict", "governance", "compliance"],
  },
  {
    id: "director-role-description",
    title: "Director Role Description",
    description: "Define board director expectations, duties, and responsibilities.",
    href: "/templates/director-role-description",
    type: "template",
    keywords: ["role", "director", "responsibilities", "governance"],
  },
  {
    id: "governance-policy-manual",
    title: "Governance Policy Manual",
    description: "Build a branded policy manual for board operations.",
    href: "/templates/governance-policy-manual",
    type: "template",
    keywords: ["manual", "policy", "governance", "operations"],
  },
];
