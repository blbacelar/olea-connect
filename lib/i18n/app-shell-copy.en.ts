...
export const appShellCopyEn: AppShellCopy = {
  breadcrumbs: {
    ...
    brand: "Brand Profile",
    community: "Community",
    grants: "Olea's Circle of Generosity",
    webinars: "Webinars",
    team: "Team",
  ...
  searchItems: {
    ...
    grants: {
      ...
      description: "Learn how 15% of Olea's profits support nonprofits through unrestricted donations.",
      keywords: ["donations", "generosity", "impact"],
    },
    sponsors: {
      title: "Sponsors",
      description: "Browse approved sponsors and contribution reporting.",
      keywords: ["partners", "contributions", "impact"],
    },
    webinars: {
      title: "Webinars",
