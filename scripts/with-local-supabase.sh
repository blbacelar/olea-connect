...
export TEST_MAILPIT_URL="${TEST_MAILPIT_URL:-http://127.0.0.1:54324}"
export NEXT_PUBLIC_SUPABASE_URL="$API_URL"
export NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY="$ANON_KEY"
export SUPABASE_SERVICE_ROLE_KEY="$SERVICE_ROLE_KEY"
export CRON_SECRET="${CRON_SECRET:-local-playwright-cron-secret}"
export COMMUNITY_MODERATION_DISABLE_AI=true
